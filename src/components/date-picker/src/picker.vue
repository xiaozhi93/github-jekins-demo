<template>
  <div class="date-icon" ref="reference" v-if="!ranged" v-clickoutside="handleClose" style="font-size:30px;display:inline-block" @click="handleFocus"> <i class="el-icon-date"></i></div>
  <!-- <el-input
